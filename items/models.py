...
class Gpu_model(models.Model):
    ...
    gpu_description = models.TextField(max_length=500, blank=True)
...
class Ram_model(models.Model):
    ...
    ram_description = models.TextField(max_length=500, blank=True)
...
class Storage_model(models.Model):
    ...
    storage_description = models.TextField(max_length=500, blank=True)
...
class Cooling_system_model(models.Model):
    ...
    cooling_system_description = models.TextField(max_length=500, blank=True)
...
class Power_supply_model(models.Model):
    ...
    power_supply_description = models.TextField(max_length=500, blank=True)
...
class Case_model(models.Model):
    ...
    case_description = models.TextField(max_length=500, blank=True)
